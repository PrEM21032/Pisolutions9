...
assert.ok(app.includes("ownerDashboard.hidden = false"),'owner_dashboard_not_revealed_after_login');
assert.ok(app.includes("ownerDashboard.hidden = true"),'owner_dashboard_not_hidden_after_logout');
assert.ok(js.includes("ownerOk()"),'owner_session_gate_missing');
